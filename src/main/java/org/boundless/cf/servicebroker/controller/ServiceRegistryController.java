...
public class ServiceRegistryController {
	...
	@Autowired
	CFDockerAppRepository cfAppInstanceRepo;
	...
	public ResponseEntity<String> createService(ServiceDefinition serviceEndpointInstance) {
		...
		Optional<ServiceDefinition> services = serviceRepo.findByServiceIdOrName(serviceName);		
	...
	*/
	...
	public ResponseEntity<String> createServices(
		...
		for(ServiceDefinition serviceInstance: serviceEndpointInstances) {
	...
	public ResponseEntity<Object> updateService(@PathVariable("serviceIdOrName") String serviceIdOrName, 
		...
		ServiceDefinition service = services.get();
	...
	public ResponseEntity<Object> getServicePlanDefn(
		...
		ServiceDefinition serviceDefn = existingService;
	...
	public ResponseEntity<String> deletePlanDefn(
		...
		ServiceDefinition service = existingPlan.getService();
	...
	@RequestMapping(value = "/cfAppInstances",
			method = RequestMethod.GET)
	public ResponseEntity<Object> getCFInstances() {
		return new ResponseEntity<>(cfAppInstanceRepo.findAll(), HttpStatus.OK);	
	}
