...
import org.boundless.cf.servicebroker.exception.ServiceDefinitionDoesNotExistException;
...
public class ServiceInstanceController extends BaseController {
	...
	public ResponseEntity<ServiceInstance> createServiceInstance(
		...
		log.debug("PUT: " + BASE_PATH + "/{instanceId}?accepts_incomplete=" + acceptsIncomplete 
		...
		log.debug("ServiceInstance Created: " + instance.getId());
	...
	public ResponseEntity<?> getServiceInstanceLastOperation(
		...
		log.debug("GET: " + BASE_PATH + "/{instanceId}/last_operation"
		...
		log.debug("ServiceInstance: " + instance.getId() + " is in " + lastOperation.getState() + " state. Details : " +lastOperation.getDescription());
	...
	public ResponseEntity<?> deleteServiceInstance(
		...
		log.debug( "DELETE: " + BASE_PATH + "/{instanceId}?accepts_incomplete=" + acceptsIncomplete 
		...
		log.debug("ServiceInstance Deleted: " + instance.getId());
	...
	public ResponseEntity<String> updateServiceInstance(
			...
			ServiceBrokerException, ServiceBrokerAsyncRequiredException {
		log.debug("UPDATE: " + BASE_PATH + "/{instanceId}?accepts_incomplete=" + acceptsIncomplete
		...
		log.debug("ServiceInstance updated: " + instance.getId());
